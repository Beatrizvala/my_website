...
Let's look at Portugal's population and GDP.
...
plot1 <- portugal_data %>% 
  ...
  labs(title = "Portugal population in the last 30 years")
...
plot2 <- portugal_data %>% 
  ...
  theme(panel.background = element_rect(fill = "lightblue",
                                colour = "lightblue",
                                size = 0.9, linetype = "solid")) +
  labs(title = "Portugal GDP in the last 30 years")

plot2
```

Source: https://databank.worldbank.org/reports.aspx?source=2&series=SP.POP.TOTL&country=PRT#